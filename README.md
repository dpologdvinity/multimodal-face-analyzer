...
- **Multi-model face analysis:** face detection, age, gender, race, emotion, gaze, drowsiness, glasses, face mask, colorimetric hair/eye color, face landmarks, plus whole-frame auto-colorization and hand landmarks -- most features have 2+ selectable model backends.
