# Vendored from https://github.com/oukohou/SSR_Net_Pytorch/blob/master/SSR_models/SSR_Net_model.py
# (PyTorch reimplementation of SSR-Net, Yang et al. IJCAI 2018). No explicit
# license file upstream; vendored verbatim for research/educational use.
import torch
